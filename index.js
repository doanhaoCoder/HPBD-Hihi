const contentLetterSrart_actived =
    "Chúc Hihi sinh nhật vui vẻ nhá. Ấn vào hộp quà đi nè."; //Lời mở đầu cho bức thư
const mainContentLetter =
    "Chúc mừng sinh nhật Hihi 🌷\n\
Chúc Hihi tuổi mới luôn mạnh khỏe, bình an và gặp thật nhiều điều may mắn trong cuộc sống. Mong rằng những điều tốt đẹp nhất sẽ luôn đồng hành trên hành trình phía trước – từ công việc, học tập đến những mối quan hệ xung quanh.\n\
\n\
Chúc Hihi sinh nhật thật ấm áp, đầy ý nghĩa và bắt đầu một tuổi mới với nhiều niềm vui, nhiều yêu thương.";
